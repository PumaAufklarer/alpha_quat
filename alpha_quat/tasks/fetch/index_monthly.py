...
@register_task("fetch_index_monthly")
class FetchIndexMonthlyTask(Task):
    """Task to fetch index monthly data."""
    ...
    def run(self, context: TaskContext) -> dict:
        ...
        logger.info(f"Fetching index monthly data: ts_code={ts_code}")
