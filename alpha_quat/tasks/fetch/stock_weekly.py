...
@register_task("fetch_stock_weekly")
class FetchStockWeeklyTask(Task):
    """Task to fetch stock weekly data."""
    ...
    def run(self, context: TaskContext) -> dict:
        ...
        logger.info(f"Fetching stock weekly data: ts_code={ts_code}")
