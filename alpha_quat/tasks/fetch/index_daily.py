...
@register_task("fetch_index_daily")
class FetchIndexDailyTask(Task):
    """Task to fetch index daily data."""
    ...
    def run(self, context: TaskContext) -> dict:
        ...
        logger.info(f"Fetching index daily data: ts_code={ts_code}")
